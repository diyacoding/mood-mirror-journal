...
const DARK_TOKENS: Record<string, string> = {
  ...
  "--shell": "linear-gradient(to bottom, hsl(268 100% 6%), hsl(272 100% 9%), hsl(270 100% 2%))",
  "--glass-bg": "linear-gradient(135deg, hsl(270 60% 18% / 0.55), hsl(270 60% 10% / 0.35))",
  "--glass-border-color": "hsl(270 96% 75% / 0.15)",
  "--glass-strong-bg": "linear-gradient(135deg, hsl(270 70% 22% / 0.7), hsl(270 60% 12% / 0.5))",
  "--glass-strong-border-color": "hsl(270 96% 75% / 0.22)",
  "--glow": "270 96% 75%",
  "--glow-deep": "264 100% 59%",
...
const LIGHT_TOKENS: Record<string, string> = {
  ...
  "--shell": "linear-gradient(to bottom, hsl(285 75% 97%), hsl(280 70% 93%), hsl(275 65% 90%))",
  "--glass-bg": "linear-gradient(135deg, hsl(0 0% 100% / 0.75), hsl(285 70% 97% / 0.6))",
  "--glass-border-color": "hsl(270 60% 55% / 0.18)",
  "--glass-strong-bg": "linear-gradient(135deg, hsl(0 0% 100% / 0.9), hsl(285 70% 96% / 0.75))",
  "--glass-strong-border-color": "hsl(270 60% 55% / 0.25)",
  "--glow": "270 90% 68%",
  "--glow-deep": "264 85% 55%",
